document.addEventListener("DOMContentLoaded", function () {
    ...
    const adv = ["jogo da adivinhação", "jogo de adivinhação", "adivinhação", "jogo da adivinhacão", "jogo de adivinhacão", "jogo da adivinhacao", "jogo de adivinhacao"]
...
$(document).ready(function(){
    $('html, body').animate({ scrollTop: 300000000000 }, 50);
